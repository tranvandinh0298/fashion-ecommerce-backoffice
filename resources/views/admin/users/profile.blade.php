            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="image">
                        ...
                        @else 
                        <img class="card-img-top img-fluid roundend-circle mt-4" style="border-radius:50%;height:80px;width:80px;margin:auto;" src="{{asset('assets/admin/img/avatar.png')}}" alt="profile picture">
                        @endif
                    </div>
...
<style>
    ...
    .image{
        background:url('{{asset('assets/admin/img/background.jpg')}}');
        height:150px;
